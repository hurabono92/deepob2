...
import { FUND_BANNER_KEY, FUND_INTRO_KEY, FUND_INTRO_DEFAULT } from "@/lib/giving-content";
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-10">
      <div className="flex flex-col gap-8 sm:flex-row">
        <SectionSidebar group={givingGroup} activeHref="/giving/fund" />

        <div className="min-w-0 flex-1">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
            <h1 className="text-xl font-bold text-ink">기금후원</h1>
            <Breadcrumb
              items={[
                { label: "처음으로", href: "/" },
          ...
          {banner?.imageUrl && (
            <SubPageBanner src={banner.imageUrl} title="기금후원" />
          )}

          <div className="mx-auto max-w-2xl py-6 text-center">
            <p className="mb-10 text-base leading-7 text-ink/70">
              {intro?.value ?? FUND_INTRO_DEFAULT}
            </p>
